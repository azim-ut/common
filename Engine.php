...
class Engine{
    ...
    public function getTemplateFile(){
        ...
        while(!empty($dirs) && !$target){
            ...
            if(!$target && file_exists($templateRoot . $checkDir . ".html")){
                $target = $checkDir . ".html";
            }
            if(!$target && file_exists($templateRoot . $checkDir . "/index.html")){
                $target = $checkDir . "/index.html";
            }
            array_pop($dirs);
        }
    ...
    public static function install(){
        ...
        foreach($implementsIModule as $row){
            $res = call_user_func(array((new $row()), "install"));
            echo $res."\r\n";
        }
    }
}
